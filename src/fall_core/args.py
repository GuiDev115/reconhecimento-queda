...
def parse_args():
    ...
    parser.add_argument("--disable-email-alert", action="store_true", help="(Legado) Desativa notificacoes no fluxo atual com central de controle.")
    parser.add_argument("--disable-notifications", action="store_true", help="Desativa acionamento de notificacoes pela central de controle.")
